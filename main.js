...
var hair = ['blonde', 'black', 'blue', 'ginger', 'red', 'purple', 'green', 'silver'];

var tries = 6;

while (tries > 0 ){
  var hairColors = prompt('What are all the different colors that I\'ve died my hair?');
  hair = hairColors.toLowerCase();
  if (){
    tries = 0;
